defmodule JobplannerDinero.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Task.Supervisor, [[name: JobplannerDinero.SyncAllContactsToMyJobPlannerSupervisor]]),
      {Task.Supervisor, name: JobplannerDinero.SyncOneContactToMyJobPlannerSupervisor }
